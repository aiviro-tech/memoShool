...
// Donnes locales retires car remplaces par API.
...
class _SuperAdminPageState extends State<SuperAdminPage>
  ...
  Future<void> _activer(dynamic compte) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(" ${compte['nom_officiel']} active"),
  ...
  Future<void> _supprimer(dynamic compte) async {
    final confirmation = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: const Text("Supprimer l'cole"),
        content: const Text(
          "Voulez-vous vraiment supprimer cette cole et toutes ses donnes ?",
        ),
        actions: [
          TextButton(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(" ${compte['nom_officiel']} supprime"),
          backgroundColor: AppColors.green,
        ),
      );
      _chargerEcoles();
            ...
            onPressed: () async {
              ...
              try {
                ...
                messenger.showSnackBar(
                  SnackBar(
                    content: Text(" ${compte['nom_officiel']} refuse"),
                    backgroundColor: AppColors.red,
                  ),
                );
                _chargerEcoles();
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (_) => AlertDialog(
                          title: Text(compte['nom_officiel'] ?? 'Dtails'),
                          content: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Tlphone: ${compte['tel_fixe'] ?? ''} / ${compte['tel_mobile'] ?? ''}",
                                ),
                                Text(
