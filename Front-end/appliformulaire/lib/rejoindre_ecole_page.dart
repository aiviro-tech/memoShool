...
class _RejoindreEcolePageState extends State<RejoindreEcolePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Rejoindre une cole"),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text(
          "Choisissez votre profil pour rejoindre une cole",
        ...
        _CarteRole(
          ...
          titre: "Enseignant",
          description:
              "Grer vos cours, dposer des supports, saisir les notes",
        ...
        _CarteRole(
          ...
          description:
              "Grer l'tablissement, valider les notes et les membres",
    ...
    try {
      ...
      if (role == null || role != widget.role) {
        setState(() {
          _isLoading = false;
          _erreur =
              "Ce code ne correspond pas au rle $_libelleRole. Vrifiez votre code.";
        });
        return;
      }
      ...
      final message =
          ...
          'Code invalide ou dj utilis. Contactez votre administration.';
      if (!mounted) return;
      setState(() {
        _isLoading = false;
        _erreur = message;
      ...
      setState(() {
        _isLoading = false;
        _erreur = 'Une erreur est survenue. Veuillez ressayer plus tard.';
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 6),
        Text(
          "Saisissez le code $_prefixeAttendu... reu de votre administration",
        ...
        Container(
          ...
          child: const Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  "Votre code vous est fourni uniquement par l'administration de votre tablissement. "
                  "tudiant : ETU-...    Enseignant : ENS-...    Admin : ADM-...",
...
class _EtapeInfosComplementairesState
  ...
  void _soumettreDemande() async {
    ...
    try {
      ...
      final message =
          e.response?.data?['message']?.toString() ??
          'Impossible de soumettre la demande. Veuillez ressayer.';
      if (!mounted) return;
      setState(() {
        _isLoading = false;
      });
        ...
        children: [
          ...
          Text(
            widget.role == 'etudiant'
                ? "Compltez votre profil tudiant"
                : widget.role == 'enseignant'
                ? "Compltez votre profil enseignant"
                : "Compltez votre profil administration",
            style: const TextStyle(color: AppColors.textSub, fontSize: 13),
          ),
          const SizedBox(height: 24),
  ...
  Widget _champsEtudiant() {
    return Column(
      children: [
        ...
        const SizedBox(height: 14),
        _champ("Numro matricule", _matriculeController),
        const SizedBox(height: 14),
        _dropdown(
          "Anne d'entre *",
          _annees,
  ...
  Widget _champsEnseignant() {
    return Column(
      children: [
        _champ("Matire principale *", _matiereController, obligatoire: true),
        const SizedBox(height: 14),
        _champ(
          "Diplme le plus lev *",
          _diplomeController,
...
// ================================================
// PAGE D'ATTENTE APRS SOUMISSION
// ================================================
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Votre demande a t soumise. L'administration de l'cole doit la valider avant que vous puissiez accder  votre espace.",
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text("Se dconnecter"),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.primary,
                    foregroundColor: Colors.white,
                    padding: const EdgeInsets.symmetric(vertical: 14),
